...
function twentytwenty_menus() {
	...
	$locations = array(
		'primary'  => __( 'Desktop Horizontal Menu', 'performance-workshop' ),
		'expanded' => __( 'Desktop Expanded Menu', 'performance-workshop' ),
		'mobile'   => __( 'Mobile Menu', 'performance-workshop' ),
		'footer'   => __( 'Footer Menu', 'performance-workshop' ),
		'social'   => __( 'Social Menu', 'performance-workshop' ),
	);
...
function twentytwenty_skip_link() {
	echo '<a class="skip-link screen-reader-text" href="#site-content">' .
		...
		__( 'Skip to the content', 'performance-workshop' ) .
	'</a>';
}
...
function twentytwenty_sidebar_registration() {
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Footer #1', 'performance-workshop' ),
				'id'          => 'sidebar-1',
				'description' => __( 'Widgets in this area will be displayed in the first column in the footer.', 'performance-workshop' ),
			)
		)
	);
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Footer #2', 'performance-workshop' ),
				'id'          => 'sidebar-2',
				'description' => __( 'Widgets in this area will be displayed in the second column in the footer.', 'performance-workshop' ),
			)
		)
	);
}
...
function twentytwenty_block_editor_settings() {
	...
	$editor_color_palette = array(
		array(
			'name'  => __( 'Accent Color', 'performance-workshop' ),
			'slug'  => 'accent',
			'color' => twentytwenty_get_color_for_area( 'content', 'accent' ),
		),
		array(
			'name'  => _x( 'Primary', 'color', 'performance-workshop' ),
			'slug'  => 'primary',
			'color' => twentytwenty_get_color_for_area( 'content', 'text' ),
		),
		array(
			'name'  => _x( 'Secondary', 'color', 'performance-workshop' ),
			'slug'  => 'secondary',
			'color' => twentytwenty_get_color_for_area( 'content', 'secondary' ),
		),
		array(
			'name'  => __( 'Subtle Background', 'performance-workshop' ),
	...
	$editor_color_palette[] = array(
		'name'  => __( 'Background Color', 'performance-workshop' ),
		'slug'  => 'background',
	...
	add_theme_support(
		...
		array(
			array(
				'name'      => _x( 'Small', 'Name of the small font size in the block editor', 'performance-workshop' ),
				'shortName' => _x( 'S', 'Short name of the small font size in the block editor.', 'performance-workshop' ),
				'size'      => 18,
				'slug'      => 'small',
			),
			array(
				'name'      => _x( 'Regular', 'Name of the regular font size in the block editor', 'performance-workshop' ),
				'shortName' => _x( 'M', 'Short name of the regular font size in the block editor.', 'performance-workshop' ),
				'size'      => 21,
				'slug'      => 'normal',
			),
			array(
				'name'      => _x( 'Large', 'Name of the large font size in the block editor', 'performance-workshop' ),
				'shortName' => _x( 'L', 'Short name of the large font size in the block editor.', 'performance-workshop' ),
				'size'      => 26.25,
				'slug'      => 'large',
			),
			array(
				'name'      => _x( 'Larger', 'Name of the larger font size in the block editor', 'performance-workshop' ),
				'shortName' => _x( 'XL', 'Short name of the larger font size in the block editor.', 'performance-workshop' ),
				'size'      => 32,
				'slug'      => 'larger',
			),
		)
